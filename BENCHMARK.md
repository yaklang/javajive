...
> ## 一句话结论（抗阶段遮蔽的类级口径）
>
> 8 个真实 jar、合计 **2252** 个顶层类：**类级干净率 96.1%（2164/2252 干净，88 个缺陷类）**，
...
> **类级干净率 96.1% 位列第一**（Vineflower 90.8%、CFR 79.7%），缺陷类总数 **88 vs CFR 457（少 81%） / Vineflower 208（少 58%）**。
...
| **反编译正确性** | 类级干净率（主口径） | **96.1%**（2164/2252，8 个真实 jar） | 表 A | ✅ |
...
（2164/2252，88 缺陷类），全集 0 语法错**——数字诚实、无遮蔽。**commons-codec 与 gson 达成完整往返**
...
| **合计** | | **88/2252（96.1%）** | 457/2254（79.7%） | 208/2252（90.8%） |
...
- **对 CFR：全面领先。** **8/8 个 jar** 上 JavaJive 缺陷类**均少于** CFR；合计缺陷类 **88 vs 457——比 CFR 少 81%**
  （干净率领先约 16 个百分点）。JSON / 序列化 / 编码族尤为悬殊：gson **0 vs 24**、fastjson2 **15 vs 90**、
  guava **20 vs 154**、commons-codec **0 vs 10**、spring-core **38 vs 117**。
- **对 Vineflower：总量领先、各擅胜场。** 合计缺陷类 **88 vs 208——比 Vineflower 少 58%**，逐 jar 各赢一部分：
