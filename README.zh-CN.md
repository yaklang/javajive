...
- **类级干净率 96.2%** —— 2,167 / 2,252 个顶层类**零 `javac` 错误**可重编译，且全 8 jar **语法错为 0**
...
- **三方横评第一** —— 类级干净率 96.2%，高于 Vineflower 1.10.1（90.8%）与 CFR 0.152（79.7%）；缺陷类 85，
  比 CFR 的 457 **少 81%**、比 Vineflower 的 208 **少 59%**，且对 CFR 8 个 jar 全胜。
