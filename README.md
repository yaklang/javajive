...
- **96.5% class-clean rate** — 2,173 / 2,252 outer classes recompile with **zero `javac`
...
- **#1 in a fair 3-way comparison** — clean-class rate 96.5% vs Vineflower 1.10.1 (90.8%) and
  CFR 0.152 (79.7%); 79 defective classes vs CFR's 457 (**83% fewer**) and Vineflower's 208
